...
const namePrefix = "YoungBulls";
const description = "Released on 30.07.2022, YoungBull's is a collection of 100 Bulls living on the Ethereum Blockchain as NFTs. Owners of this NFT in a month will be able to improve their bull and how it will look is already a surprise that you will find out only in a month";
...
const CONTRACT_NAME = 'YOUNGBULLS';
const CONTRACT_SYMBOL = 'YB';
const METADATA_UPDATABLE = true; // set to false if you don't want to allow metadata updates after minting
const OWNER_ADDRESS = '0xaA7018104bbD6C4C4f74A3ba401779F7D7C9e0d1';
const TREASURY_ADDRESS = '0xaA7018104bbD6C4C4f74A3ba401779F7D7C9e0d1';
...
const PRESALE_MINT_START_DATE = "2022-07-25T8:30:48+00:00"; // Optional. Eg: 2022-02-08T11:30:48+00:00
const ROYALTY_SHARE = 1000; // Percentage of the token price that goes to the royalty address. 100 bps = 1%
const ROYALTY_ADDRESS = "0xaA7018104bbD6C4C4f74A3ba401779F7D7C9e0d1"; // Address that will receive the royalty
const BASE_URI = null; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = [0xaA7018104bbD6C4C4f74A3ba401779F7D7C9e0d1]; // only update if you want to manually set the whitelisted addresses

// ** OPTIONAL **
let CONTRACT_ADDRESS = "Y0xaA7018104bbD6C4C4f74A3ba401779F7D7C9e0d1S"; // If you want to manually include it
