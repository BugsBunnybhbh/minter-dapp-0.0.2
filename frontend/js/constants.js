const contractAddress = "0x943F381B0DFA7a0Bf37e526F2e64924608fdF81B"; // Replace with your own contract address
const chain = 'rinkeby'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the YoungBulls Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The YoungBulls this is an interesting project which is that over time you will improve your NFT';
const h1_presale_coming_soon = "Bulls Drop Coming Soon!!";
